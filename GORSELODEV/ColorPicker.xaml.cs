...
{
    private string[] colorNames = { "Kırmızı", "Yeşil", "Mavi", "Sarı", "Mor", "Pembe", "Turuncu", "Gri", "Beyaz", "Siyah" };
    ...
    private async void ColorCode_Tapped(object sender, EventArgs e)
    {
        ...
        await DisplayAlert("Kopyalandı", "Renk kodu panoya kopyalandı.", "Tamam");
    }

    private async void ColorPickerButton_Clicked(object sender, EventArgs e)
    {
        string selectedColor = await DisplayActionSheet("Renk Seçici", "İptal", null, colorNames);
